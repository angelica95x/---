...
const TELEGRAM_BOT_TOKEN = '8222285747:AAGRcpz4bLonicE81qTjTUE_dpXh-JrfNaA'; 
const OWNER_ID = 8451193007;
const USERNAME_OWNER = '@shadow95x'; 

// 2. Syarat Join (Channel & Group)
const VERIFICATION_GROUP_USERNAME = '@kagenox95'; 
const VERIFICATION_CHANNEL_USERNAME = '@testi_kageno'; 
...
const FIX_COOLDOWN = 15 * 60 * 1000;

// 4. Sistem Referral & Backup
const REFERRAL_COUNT_NEEDED = 2; 
...
const START_AUDIO_FILE = 'h4zellions.mp3';
const SECONDARY_IMAGE_FILE = 'zell1.jpg'; 
